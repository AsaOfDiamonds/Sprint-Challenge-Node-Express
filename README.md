...
- [x] Mention two parts of Express that you learned about this week.
        Two of the parts I learned about for Express this week were Middleware and Routing.
         Since the next 2 questions ask about those I will discuss further in the following questions.

- [x] Describe Middleware?
        Middleware helps us with common “routines” or functions that we want to happen (sometimes more than once). 
        Whether it is 3rd part middleware like morgan (for logging), helmet (for security), 
        or something that you create on your own (like maybe a function) to help with your application.
        It is important to remember that they get executed in the order that they put in the code. 
        From top to bottom and left to right.

- [x] Describe a Resource?
        I think a resource is component (like data or routine)

- [x] What can the API return to help clients know if a request was successful?
        Status codes like 200.

- [x] How can we partition our application into sub-applications?
        We can use express.Router to to break up our application into sub applications.
